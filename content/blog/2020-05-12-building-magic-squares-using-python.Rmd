...
description: ''
---
A magic square is a n x n square grid (where n is the number of cells on each side) filled with distinct positive integers in the range 1,2,...,n^2 such that each cell contains a different integer and the sum of the integers in each row, column and diagonal is equal. An example is shown in the picture below.
...
**NOTE This code is an intelectual property and should not be copied by anyone taking CS 303E course at the University of Texas at Austin!**
```{r}
library(reticulate)
```
